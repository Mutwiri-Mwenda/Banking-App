...
const Hero = () => (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 w-[100%] h-[100%]`}>
        ...
        <h1 className='flex-1 font-poppins font-semibold ss:text-[60px] text-[48px] text-white ss:leading-[100px] leading-[75px] w-full'>
          Payment Method.
        </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="billing" className='w-[669px] h-[669px] relative z-[5] left-771px right-112px' />
